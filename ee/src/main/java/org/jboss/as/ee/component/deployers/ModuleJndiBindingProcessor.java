...
public class ModuleJndiBindingProcessor implements DeploymentUnitProcessor {
    ...
    private static final boolean IGNORE_UNIMPLEMENTED_RESOURCE_BINDING = Boolean.valueOf(WildFlySecurityManager.getPropertyPrivileged("jboss.ee.ignore-unimplemented-resource-binding", "false"));
    ...
    public void deploy(final DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (!IGNORE_UNIMPLEMENTED_RESOURCE_BINDING && !MetadataCompleteMarker.isMetadataComplete(phaseContext.getDeploymentUnit()) && !appClient) {
